module.exports.config = {
	...
	version: "1.0.2",
	hasPermssion: 0,
	credits: "Elin Mohamed • إلينمحمد",//wag niyo na ichange mga patay gutom
	description: "قائمة الاوامر",
	commandCategory: "system • النظام",
	usages: ".الأقسام",
	cooldowns: 1,
	envConfig: {
		autoUnsend: true,
...
module.exports.languages = {
	"en": {
		"moduleInfo": "─────[ %1 ]──────\n\nUG • الاستخدام: %3\nCTY • الفئة: %4\nWT • وقت الانتظار: %5 ثانية(و)\nPMS • الصلاحية: %6\nDC • الوصف: %2\n\nMCBy • تم برمجته بواسطة : Elin Mohamed | آليہنہ يہيہغہر ﮩٰۧ ﮩٰۧ",
		"helpList": '[ يوجد  %1 أمر في هذا البوت، اكتب: "%2قائمة اسم الامر" لتعرف كيف تستخدخه 👽! ]',
		"user": "User",
...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `『𝗟𝗶𝘀𝘁 𝗼𝗳 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 | قائمة الاوامر』\nPage • صفحة 『${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}』`;
 ...
 const text = `━━━━━━━━━━━━━━━━\n╰┈➤${global.config.BOTNAME} C3C AI \n╰┈➤Dev:\nwww.facebook.com/ElinYeager726`;
    var link = [
      "https://i.postimg.cc/sXQXXHgw/received-1069239864345252.jpg",
      "https://i.postimg.cc/sXQXXHgw/received-1069239864345252.jpg",
    ]
